...
//		
//		basePage.waitForAllElementClickable(driver, "//button[@class='button-1 register-next-step-button']");
//		basePage.clickToElement(driver, "//button[@class='button-1 register-next-step-button']");
//		
...
//		basePage.sendKeyToElement(driver, "//input[@id='Email']", "12345@&I&*^");
...
//
//		basePage.waitForAllElementClickable(driver, "//a[@class='ico-login']");
